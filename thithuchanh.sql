...
VALUES 
    ('John Doe','BacNinh', 'Vietnam', '+84 123 456 789', 'johndoe@email.com'),
    ('Jane Doe','HaNoi', 'Vietnam', '+84 987 654 321', 'janedoe@email.com'),
...
VALUES
    ('A00000001', 1, 10000, 10000),
    ('A00000002', 2, 20000, 20000),
    ('A00000003', 3, 30000, 30000);
